...
class DiscoverServices < Menu
  def menu
    ...
    puts "Common:".yellow
    puts "7.  TCP top 1000 ports + version + OS"
    puts "8.  UDP top 1000 ports + version + OS"
    puts "9.  TCP/UDP top 1000 ports + version + OS"
    puts "Detailed:".yellow
    puts "10. TCP top 1000 ports + version + OS + scripts"
    puts "11. UDP top 1000 ports + version + OS + scripts"
    puts "12. TCP/UDP top 1000 ports + version + OS + scripts"
    ...
    when 7 then GNmap.new("DiscoverServices", "Nmap - TCP top 1000 ports + version + OS").menu("tcp_quick_vo")
    when 8 then GNmap.new("DiscoverServices", "Nmap - UDP top 1000 ports + version + OS").menu("udp_quick_vo")
    when 9 then GNmap.new("DiscoverServices", "Nmap - TCP/UDP top 1000 ports + version + OS").menu("tcp_udp_quick_vo")
    when 10 then GNmap.new("DiscoverServices", "Nmap - TCP top 1000 ports + version + OS + scripts").menu("tcp_quick_vo_scripts")
    when 11 then GNmap.new("DiscoverServices", "Nmap - UDP top 1000 ports + version + OS + scripts").menu("udp_quick_vo_scripts")
    when 12 then GNmap.new("DiscoverServices", "Nmap - TCP/UDP top 1000 ports + version + OS + scripts").menu("tcp_udp_quick_vo_scripts")
