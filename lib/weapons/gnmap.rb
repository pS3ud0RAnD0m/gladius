...
# Execute method
  def execute(run_method)
    ...
    when "tcp_quick_vo_scripts"     then cmd_infix = "-Pn -sSV -O -T4 --min-hostgroup 128 --script 'default,vuln'"
    ...
    when "tcp_udp_quick_vo_scripts" then cmd_infix = "-Pn -sSUV -O -T4 --min-hostgroup 128 --script 'default,vuln'"
    ...
    when "udp_quick_vo_scripts"     then cmd_infix = "-Pn -sUV -O -T4 --min-hostgroup 128 --script 'default,vuln'"
