...
# Execute method
  def execute(run_method)
    ...
    when "tcp_quick_vo_scripts"     then cmd_infix = "-Pn -sSVC -O -T4 --min-hostgroup 128"
    ...
    when "tcp_udp_quick_vo_scripts" then cmd_infix = "-Pn -sSUVC -O -T4 --min-hostgroup 128"
    ...
    when "udp_quick_vo_scripts"     then cmd_infix = "-Pn -sUVC -O -T4 --min-hostgroup 128"
